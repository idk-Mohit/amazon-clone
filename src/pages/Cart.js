...
import { CartHolder, NoProduct, CartProductCard, SubTotal, SubTotalAmount } from '../components'
                    ...
                    <div className='flex-column'>
                        {Cart.items.length < 1 ?
                            ...
                            (<Products>
                                ...
                                <SubTotalAmount totalQty={Cart.totalQuantity} price={priceToPay} loading={loadingRef.current} />
                            </Products>)
                        }
                    </div>
